...
public class AdminDomesticController {
    ...
    @PostMapping(value = "/domestic-itineraries/{itineraryId}/schedules/{scheduleId}/images", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public DomesticItineraryImageDto uploadScheduleImage(
            @PathVariable Long productId,
            @PathVariable Long itineraryId,
            @PathVariable Long scheduleId,
            @RequestParam("file") MultipartFile file
    ...
    @DeleteMapping("/domestic-itineraries/{itineraryId}/schedules/{scheduleId}/images/{imageId}")
