...
public class AdminProductController {
    ...
    public AdminProductController(AdminProductService productService, UserRepository userRepository) {
    ...
    /* 등록 */
    @PostMapping
    public int insert(@RequestBody ProductDto dto, Principal principal) {
